...
The **OPT** panel can independently enable or disable asteroids, mineral drops, shooting stars, planets, alien ships, space stations, procedural mission music, sound effects, particle effects, and screen shake. Choices and separate music/SFX volume levels are saved locally. A **Test Audio** control explicitly unlocks browser audio and plays a confirmation sound. The soundtrack is generated with the Web Audio API and automatically fades while gameplay is paused or between missions.
